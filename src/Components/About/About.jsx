    ...
    >
      ...
      <div className={styles.second}>
        ...
        <p style={{ color: `${newTheme.para}` }} className={styles.aboutMe}>
          Hello! My name is Neeraj Malviya and I like to build websites/application that
          ...
          development started when I joined Masai School to Java Back-End
          Development — taught me alot about Java,HTML & CSS. <br />
          ...
          <span style={{ color: `#00a0a0` }}>
            {" "}
            looking for an opportunity as a Back-End developer
          </span>
          .
        </p>
      </div>
